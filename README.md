...
- **[Apple Silicon download](https://github.com/distantg/xFlow/releases/download/v2.2.4/Mosaic-AppleSilicon.dmg)**: M1, M2, M3, M4, or newer
- **[Intel download](https://github.com/distantg/xFlow/releases/download/v2.2.4/Mosaic-Intel.dmg)**: older Intel-based Macs
